...
MODEL_PATH = r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\models\AlexNetModel.hdf5'
...
def convert(s):
    ...
    elif(s=='Apple___Cedar_apple_rust'):
    ...
    elif(s=='Cherry_(including_sour)___Powdery_mildew'):
    ...
    elif(s=='Cherry_(including_sour)___healthy'):
    ...
    elif(s=='Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot'):
    ...
    elif(s=='Corn_(maize)___Common_rust_'):
    ...
    elif(s=='Corn_(maize)___Northern_Leaf_Blight'):
    ...
    elif(s=='Grape___Esca_(Black_Measles)'):
    ...
    elif(s=='Grape___Leaf_blight_(Isariopsis_Leaf_Spot)'):
    ...
    elif(s=='Orange___Haunglongbing_(Citrus_greening)'):
    ...
    elif(s=='Pepper,_bell___Bacterial_spot'):
    ...
    elif(s=='Squash___Powdery_mildew'):
    ...
    elif(s=='Strawberry___Leaf_scorch'):
    ...
    elif(s=='Tomato___Bacterial_spot'):
    ...
    elif(s=='Tomato___Septoria_leaf_spot'):
    ...
    elif(s=='Tomato___Spider_mites Two-spotted_spider_mite'):
    ...
    elif(s=='Tomato___Tomato_Yellow_Leaf_Curl_Virus'):
    ...
    elif(s=='Tomato___Tomato_mosaic_virus'):
...
def convert_image_edge_cluster(img_path):
    ...
    cv2.imwrite(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test1.jpg', blur,[cv2.IMWRITE_JPEG_QUALITY, 100])
    ...
    #horizontal edge
    Gy=convolve2d(bw,hy)
    cv2.imwrite(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test4.jpg', Gx,[cv2.IMWRITE_JPEG_QUALITY, 100])
    
    #main edge
    G=np.sqrt(Gx*Gx + Gy*Gy)
    cv2.imwrite(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test5.jpg', G,[cv2.IMWRITE_JPEG_QUALITY, 100])
    
    #Canny Edge
    edges = cv2.Canny(img,100,150)
    cv2.imwrite(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test3.jpg', edges,[cv2.IMWRITE_JPEG_QUALITY, 100])
    
    #green filter
    green_image = img.copy() # Make a copy
    green_image[:,:,0] = 0
    green_image[:,:,2] = 0
    cv2.imwrite(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test2.jpg', green_image,[cv2.IMWRITE_JPEG_QUALITY, 100])
    ...
    img_c.save(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test6.jpg')
    K=3
    ret,label,center=cv2.kmeans(vectorized,K,None,criteria,attempts,cv2.KMEANS_PP_CENTERS)
    center = np.uint8(center)
    res = center[label.flatten()]
    ...
    img_c.save(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test7.jpg')
    K=4
    ret,label,center=cv2.kmeans(vectorized,K,None,criteria,attempts,cv2.KMEANS_PP_CENTERS)
    center = np.uint8(center)
    res = center[label.flatten()]
    ...
    img_c.save(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test8.jpg')
    K=5
    ret,label,center=cv2.kmeans(vectorized,K,None,criteria,attempts,cv2.KMEANS_PP_CENTERS)
    center = np.uint8(center)
    res = center[label.flatten()]
    ...
    img_c.save(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test9.jpg')
    K=6
    ret,label,center=cv2.kmeans(vectorized,K,None,criteria,attempts,cv2.KMEANS_PP_CENTERS)
    center = np.uint8(center)
    res = center[label.flatten()]
    ...
    img_c.save(r'C:\Users\heman\Desktop\MinorProject\PlantsDiseaseDetection\static\clustor\test10.jpg')
